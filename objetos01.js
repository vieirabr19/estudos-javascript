...
var obj06 = new Function(
  "parametroNome",
  "return 'olá ' + parametroNome + '!'"
);
...
console.log(
  "objetoProduto['nome no formato string valido']",
  objetoProduto["nome no formato string valido"]
);
...
console.log(
  "tatal in pedido com hasOwnProperty:",
...
console.log(
  "Object.prototype.toString.call(valoresProp)",
  Object.prototype.toString.call(valoresProp)
);
console.log(
  "verificar se é um array com Array.isArray",
  Array.isArray(valoresProp)
);
...
console.log(
  "Object.prototype.toString.call(chavesValoresObjeto)",
  Object.prototype.toString.call(chavesValoresObjeto)
);
console.log(
  "verificar se é um array com Array.isArray",
  Array.isArray(chavesValoresObjeto)
);
...
console.log(
  ...
  Object.getOwnPropertyDescriptors(folhaPagamento)
);
...
console.log(
  "objTeste.propertyIsEnumerable('a'):",
  objTeste.propertyIsEnumerable("a")
);
console.log(
  "objTeste.propertyIsEnumerable('toString'):",
  objTeste.propertyIsEnumerable("toString")
);
console.log(
...
console.log(
  "1 - Object.getOwnPropertyDescriptor(objCarro, 'cor'):",
...
console.log(
  "4-Object.getOwnPropertyDescriptor(objCarro, 'toString')):",
  Object.getOwnPropertyDescriptor(objCarro, "toString")
);
console.log(
  "5-Object.getOwnPropertyDescriptor(objCarro, 'length')):",
  Object.getOwnPropertyDescriptor(objCarro, "length")
);
console.log(
  "5-Object.getOwnPropertyDescriptor(objCarro, 'placa')):",
...
console.log(
  "Object.preventExtensions(objMoto):",
  Object.preventExtensions(objMoto)
);
...
livro.ebook = true;
console.log(
  "add ebook - livro.hasOwnProperty('ebook'):",
  livro.hasOwnProperty("ebook")
);
...
console.log(
  "Congelando o objeto(Object.freeze(artigo)): ",
  Object.freeze(artigo)
);
console.log("Object.isFrozen(artigo)?", Object.isFrozen(artigo));
console.log("Object.isExtensible(artigo)?", Object.isExtensible(artigo));
console.log("Object.isSealed(artigo)?", Object.isSealed(artigo));
...
var pessoa = {
  ...
  endereco: {
    ...
    numeto: 367,
    cep: "620234562",
    pontoRef: { ponto1: "ponto ref 1", ponto2: "ponto ref 2" },
  },
