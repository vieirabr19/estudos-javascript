/*Função anônima é uma forma de definir uma função sem nome, neste formato não pode ser invocada diretamente*/
/*Como usar:
...
- Não pode ser chamada diretamente, evitando que qualquer pessoa possa chamar via console do browser;
