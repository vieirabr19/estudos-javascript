...
console.log(
  "arrayConcat.concat([11,12,13,14,15])",
  arrayConcat.concat([11, 12, 13, 14, 15])
);
console.log(
  "arrayConcat.concat({teste: 'teste'})",
  arrayConcat.concat({ teste: "teste" })
);
...
console.log(
  "produtos.slice(0, produtos.length)",
  produtos.slice(0, produtos.length)
);
console.log(
  "produtos.slice(3, produtos.length)",
  produtos.slice(3, produtos.length)
);
...
numSplice = [1, 2, 3, 4, 5, 6, 7];
console.log(
  'numSplice.splice(0,0,"a","b","c"):',
  numSplice.splice(0, 0, "a", "b", "c")
);
console.log("->", numSplice);

console.log(
  'numSplice.splice(numSplice.length,0,"s","r","z"):',
  numSplice.splice(numSplice.length, 0, "s", "r", "z")
);
console.log("->", numSplice);
...
console.log(
  'numSplice.splice(3,0,"a","b","c"):',
  numSplice.splice(3, 2, "a", "b", "c")
);
console.log("->", numSplice);

console.log(
  "numSplice.splice(2,1,['a','b','c']):",
  numSplice.splice(2, 1, ["a", "b", "c"])
);
console.log("->", numSplice);

console.log(
  "numSplice.splice(2,1,{teste:'teste'}):",
  numSplice.splice(2, 1, { teste: "teste" })
);
console.log("->", numSplice);
...
console.log("reduce-------------------");
var retornoReduce = testeReduce.reduce(function (
  acumulador,
  valorEleArray,
  indice,
  array
...
var valorInicial = 2;
var retornoReduce = testeReduce.reduceRight(function (
  acumulador,
  valorEleArray,
  indice,
  array
